...
<div class="col-md-10 nomargin">
  <div class="row">
 <div id="videolist-content" class="oboxed col-md-10"> 
<?php echo _ad('0','playlists-top');
      ...
      if ($playlists) {
          ...
          foreach ($playlists as $pl) {
              ...
              $ov = '';	
              $grid = '';
              $pictures = get_playlist_img($pl->id);		
              if($pictures) {
                  ...
                  foreach($pictures as $picture) {					
                      ...
                      $grid .= '<img src="'.thumb_fix($picture->thumb).'"/>';
                      $grid .= '</div>';
                      $i++;
                  }
                  $grid .= '</div>';
...
<?php $ad = _ad('0','playlists-sidebar');
      if(!empty($ad)) {
          echo '<div id="SearchSidebar" class="col-md-2 oboxed">'.$ad.'</div>';
      }
?>
</div>
